...
myLayoutHook =
    ...
    where
        tall = Tall 1 0.1 0.5
        dwindle = renamed [Replace "Dwindle"] (Dwindle R CW 0.5 0.1)
...
myKeybindings x = mkKeymap
    ...
    , ( "<XF86AudioLowerVolume>"
      , spawn "pamixer -d 5" >> spawn "sleep 0.1; statusbar-scripts/send-volume.py $(pamixer --get-volume)"
      )
    , ( "<XF86AudioRaiseVolume>"
      , spawn "pamixer -i 5" >> spawn "sleep 0.1; statusbar-scripts/send-volume.py $(pamixer --get-volume)"
      )
    ...
    , ("M-q", spawn "killall dzen2 picom; xmonad --recompile; xmonad --restart")
    ...
    , ("M-v", sendMessage $ JumpToLayout "Dwindle")
    ]
